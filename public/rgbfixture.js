...
class RGBFixture extends Fixture {
    constructor(number) {
        ...
        this.redChannelInput = createInput();
        ...
        this.greenChannelInput = createInput();
        ...
        this.blueChannelInput = createInput();
        ...
        this.whiteChannelInput = createInput();
        ...
        this.brightnessChannelInput = createInput();
